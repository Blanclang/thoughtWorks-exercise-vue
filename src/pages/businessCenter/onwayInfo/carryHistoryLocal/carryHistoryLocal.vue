...
<template>
  <el-dialog title="承运商上报历史位置" :visible.sync="visible" width="900px" :before-close="closeDialog">
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        tableColumn: [
          ...
          {prop: 'reportLocationName',label: '上报位置',align: 'center'},
    ...
    methods: {
      getData() {
        this.loading = true;
        let requestPromise = this.$root.getCarryHistoryLocation(this.form);
